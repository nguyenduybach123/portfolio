  ...
  return (
    ...
    >
      <div className='relative z-10 max-w-4xl text-center'>
        {/* Main Heading */}
        <motion.h1 variants={itemVariants} className='mb-6 font-serif text-5xl md:text-7xl'>
          <span className='text-slate-700'>Hi ! I&apos;m </span>
          <TypingAnimation className='text-orange-500'>Duy Bach.</TypingAnimation>
        </motion.h1>

        {/* Subtitle */}
        <motion.p variants={itemVariants} className='mb-12 text-lg text-slate-500 md:text-xl'>
