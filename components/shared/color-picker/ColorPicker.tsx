...
const ColorPicker = (props: ColorPickerProps) => {
  const { disabled = false, value, onChange, colors = COLORS_LIST, highlight } = props
  ...
  return (
    <Popover modal onOpenChange={setOpen} open={open}>
      ...
      <PopoverContent align='start' className='richtext-size-full !richtext-p-2' hideWhenDetached side='bottom'>
        <div className='richtext-flex richtext-flex-col'>
          ...
          >
            <span className='richtext-ml-1 richtext-text-sm'>{highlight ? 'No Fill' : 'Default'}</span>
          </div>
          ...
          <div>
            <div className='richtext-my-1 richtext-text-sm'>Recently Used</div>
  ...
  return (
    <Popover onOpenChange={setOpenColorMore} open={openColorMore}>
      <PopoverTrigger asChild>
        <div className='richtext-p-1.5 richtext-text-sm hover:richtext-cursor-pointer hover:richtext-bg-accent'>
          More Colors
        </div>
      </PopoverTrigger>
